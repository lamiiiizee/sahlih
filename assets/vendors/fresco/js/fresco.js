      ...
      return {
        ...
        Opera:
          ...
          ((!!window.opera && opera.version && parseFloat(opera.version())) ||
            7.55),
        WebKit:
          i.indexOf("AppleWebKit/index.html") > -1 &&
          e("AppleWebKit/index.html"),
        Gecko: i.indexOf("Gecko") > -1 && -1 === i.indexOf("KHTML") && e("rv:"),
        MobileSafari: !!i.match(/Apple.*Mobile.*Safari/),
        Chrome: i.indexOf("Chrome") > -1 && e("Chrome/index.html"),
        ChromeMobile: i.indexOf("CrMo") > -1 && e("CrMo/index.html"),
        Android: i.indexOf("Android") > -1 && e("Android "),
        IEMobile: i.indexOf("IEMobile") > -1 && e("IEMobile/index.html"),
      };
    })(navigator.userAgent),
          ...
          Support.mobileTouch ||
            ...
            Window.element
              .on(
                "mouseenter",
                ".fr-side",
                (this._onSideMouseEnterHandler =
                  this._onSideMouseEnter.bind(this))
              )
              .on(
                "mouseleave",
                ".fr-side",
                (this._onSideMouseLeaveHandler =
                  this._onSideMouseLeave.bind(this))
              ),
            $(window).on(
              "scroll",
